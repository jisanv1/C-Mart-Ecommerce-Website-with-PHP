...
if(isset($_POST['add_brand'])){
    ...
    if(!empty($file_name)){
         ...
         if($file){
            $update_name = rand().$file_name;
            move_uploaded_file($tmp_name, '../assets/img/products/brand/'.$update_name);
         ...
         $brand_insert = "INSERT INTO mart_brand (b_name, b_logo, b_status) VALUES ('$brand_name', '$update_name','1')";
         $brand_insert_res = mysqli_query($db,$brand_insert);
...
if(isset($_POST['add_product'])){
    ...
    if($file){
        ...
        $pinsertSQL = "INSERT INTO mart_products(p_name,p_short_desc,p_big_desc,p_reg_price,p_offer_price,p_featured_img,p_image_galery,p_quantity,p_status,p_category,p_brand) VALUES('$name','$sdesc','$ldesc','$rPrice','$oPrice','$updatedname','$galleryimages', '$stock', '1', '$cat','$brand')";
