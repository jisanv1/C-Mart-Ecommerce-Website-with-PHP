    ...
    <section class="section dashboard">
      ...
      $data = isset($_GET['data']) ? $_GET['data'] : 'view';
                  ...
                  <div class="dataTable-container">
                    <table class="table datatable dataTable-table">
                      ...
                      while($row = mysqli_fetch_assoc($products)){
                          ...
                          $p_image_gallery = $row['p_image_galery'];
                  ...
                  <div class="form-group mb-3">
                    ...
                    <!-- <div class="quill-editor-full ql-container ql-snow" style ="min-height: 300px;">
                        ...
                        <div class="ql-tooltip ql-hidden">
                            ...
                            <input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL" name="long_description">
                                <a class="ql-action">
        ...
        if($data == 'edit'){
            ...
            $p_image_gallery2 = $row['p_image_galery'];
